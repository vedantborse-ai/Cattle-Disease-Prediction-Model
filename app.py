...
# --- 5. MAIN INTERFACE ---
if model is None:
    st.error("⚠️ Model folder missing in repo.")
else:
    ...
    if uploaded_file:
        ...
        with c2:
            ...
            <div style='margin-bottom: 20px;'>
                <span style='font-size: 1rem; letter-spacing: 2px; color: {color};'>Detected Condition</span>
            ...
            fig.update_layout(
                ...
                yaxis=dict(showgrid=False, color='#C0C3C9'),
                showlegend=False
            )
